...
var CaretDownArrow = memo2((props) => {
...
var Checkmark = memo3((props) => {
  return /* @__PURE__ */ React4.createElement("svg", {
    ...
    xmlSpace: "preserve"
  }, /* @__PURE__ */ React4.createElement("g", null, /* @__PURE__ */ React4.createElement("path", {
...
import React5, { memo as memo4 } from "react";
var Checkmark2 = memo4((props) => {
...
import React8, { memo as memo7 } from "react";
var FileUpload = memo7((props) => {
...
import React9, { memo as memo8 } from "react";
var GearCog = memo8((props) => {
...
import React10, { memo as memo9 } from "react";
var Search = memo9((props) => {
...
import React11, { memo as memo10 } from "react";
var TrashCan = memo10((props) => {
...
import React12, { memo as memo11 } from "react";
var Upload = memo11((props) => {
  return /* @__PURE__ */ React12.createElement("svg", {
    ...
    xmlSpace: "preserve"
  }, /* @__PURE__ */ React12.createElement("g", null, /* @__PURE__ */ React12.createElement("path", {
...
import React13, { memo as memo12 } from "react";
var Add = memo12((props) => {
  return /* @__PURE__ */ React13.createElement("svg", {
    ...
    offset: 1,
    stopColor: "#5C5ACA"
  })), /* @__PURE__ */ React13.createElement("linearGradient", {
...
import React14, { memo as memo13 } from "react";
var AddCircle = memo13((props) => {
...
import React15, { memo as memo14 } from "react";
var Building = memo14((props) => {
  ...
  }), /* @__PURE__ */ React15.createElement("defs", null, /* @__PURE__ */ React15.createElement("linearGradient", {
    id: "prefix__paint0_linear",
    x1: 17,
    y1: 8,
    x2: 17,
...
import React16, { memo as memo15 } from "react";
var ChevronDoubleForward = memo15((props) => {
  return /* @__PURE__ */ React16.createElement("svg", {
    ...
    offset: 1,
    stopColor: "#5C5ACA"
  })), /* @__PURE__ */ React16.createElement("linearGradient", {
    id: "prefix__paint1_linear",
    x1: 5,
    y1: 12,
    x2: 13.086,
...
import React17, { memo as memo16 } from "react";
var Dashboard = memo16((props) => {
  return /* @__PURE__ */ React17.createElement("svg", {
    ...
    fill: "url(#prefix__paint1_linear)"
  }), /* @__PURE__ */ React17.createElement("defs", null, /* @__PURE__ */ React17.createElement("linearGradient", {
    id: "prefix__paint0_linear",
    x1: 12,
    y1: 3,
    x2: 12,
...
import React18, { memo as memo17 } from "react";
var Document = memo17((props) => {
  return /* @__PURE__ */ React18.createElement("svg", {
    ...
    fill: "url(#prefix__paint3_linear)"
  }), /* @__PURE__ */ React18.createElement("defs", null, /* @__PURE__ */ React18.createElement("linearGradient", {
    id: "prefix__paint0_linear",
    x1: 12,
    y1: 2,
    x2: 12,
...
import React19, { memo as memo18 } from "react";
var Gift = memo18((props) => {
  return /* @__PURE__ */ React19.createElement("svg", {
    ...
    fill: "url(#prefix__paint2_linear)"
  }), /* @__PURE__ */ React19.createElement("defs", null, /* @__PURE__ */ React19.createElement("linearGradient", {
    id: "prefix__paint0_linear",
    x1: 12,
    y1: 12.874,
    x2: 12,
    y2: 22,
    gradientUnits: "userSpaceOnUse"
  }, /* @__PURE__ */ React19.createElement("stop", {
    stopColor: "#fff"
  }), /* @__PURE__ */ React19.createElement("stop", {
    offset: 1,
    stopColor: "#D1DAEE"
  })), /* @__PURE__ */ React19.createElement("linearGradient", {
    id: "prefix__paint1_linear",
    x1: 12,
    y1: 6,
    x2: 12,
...
import React20, { memo as memo19 } from "react";
var Group = memo19((props) => {
...
import React21, { memo as memo20 } from "react";
var Growth = memo20((props) => {
...
import React22, { memo as memo21 } from "react";
var Home = memo21((props) => {
...
import React23, { memo as memo22 } from "react";
var Inbox = memo22((props) => {
...
// src/dual-light/Messages.tsx
import { memo as memo24 } from "react";
var Messages = memo24((props) => {
  return /* @__PURE__ */ React.createElement("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
...
// src/dual-light/Note.tsx
import { memo as memo25 } from "react";
var Note = memo25((props) => {
  return /* @__PURE__ */ React.createElement("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
...
import React24, { memo as memo26 } from "react";
var Send = memo26((props) => {
...
import React25, { memo as memo27 } from "react";
var Star = memo27((props) => {
...
import React26, { memo as memo28 } from "react";
var Settings = memo28((props) => {
  return /* @__PURE__ */ React26.createElement("svg", {
    ...
    fill: "url(#prefix__paint1_linear)"
  }), /* @__PURE__ */ React26.createElement("defs", null, /* @__PURE__ */ React26.createElement("linearGradient", {
    id: "prefix__paint0_linear",
    x1: 12,
    y1: 1,
    x2: 12,
    y2: 23,
    gradientUnits: "userSpaceOnUse"
  }, /* @__PURE__ */ React26.createElement("stop", {
    stopColor: "#fff"
  }), /* @__PURE__ */ React26.createElement("stop", {
    offset: 1,
    stopColor: "#D1DAEE"
  })), /* @__PURE__ */ React26.createElement("linearGradient", {
    id: "prefix__paint1_linear",
    x1: 12,
    y1: 9,
    x2: 12,
...
import React27, { memo as memo29 } from "react";
var Tool = memo29((props) => {
...
import React28, { memo as memo30 } from "react";
var Trash = memo30((props) => {
...
import React29, { memo as memo31 } from "react";
var Warning = memo31((props) => {
  return /* @__PURE__ */ React29.createElement("svg", {
    ...
    r: 1,
    fill: "url(#prefix__paint2_linear)"
  }), /* @__PURE__ */ React29.createElement("defs", null, /* @__PURE__ */ React29.createElement("linearGradient", {
    id: "prefix__paint0_linear",
    x1: 12,
    y1: 0,
    x2: 12,
    y2: 21,
    gradientUnits: "userSpaceOnUse"
  }, /* @__PURE__ */ React29.createElement("stop", {
    stopColor: "#fff"
  }), /* @__PURE__ */ React29.createElement("stop", {
    offset: 1,
    stopColor: "#D1DAEE"
  })), /* @__PURE__ */ React29.createElement("linearGradient", {
    id: "prefix__paint1_linear",
    x1: 12,
    y1: 14,
    x2: 12,
...
import React30, { memo as memo33 } from "react";
var Upload2 = memo33((props) => {
  return /* @__PURE__ */ React30.createElement("svg", {
    ...
    fill: "url(#paint1_linear)"
  }), /* @__PURE__ */ React30.createElement("defs", null, /* @__PURE__ */ React30.createElement("linearGradient", {
    id: "paint0_linear",
    x1: "12.0009",
    y1: "4.49951",
    x2: "12.0009",
...
function getIcon(name) {
  switch (name) {
    case "basic/Alert.svg" /* Alert */:
      return Alert;
    case "basic/CaretDownArrow.svg" /* CaretDownArrow */:
      return CaretDownArrow;
    case "basic/Checkmark.svg" /* Checkmark */:
      return Checkmark;
    case "basic/Checkmark2.svg" /* Checkmark2 */:
      return Checkmark2;
    case "basic/Close.svg" /* Close */:
      return Close;
    case "basic/Exit.svg" /* Exit */:
      return Exit;
    case "basic/FileUpload.svg" /* FileUpload */:
      return FileUpload;
    case "basic/GearCog.svg" /* GearCog */:
      return GearCog;
    case "basic/Search.svg" /* Search */:
      return Search;
    case "basic/TrashCan.svg" /* TrashCan */:
      return TrashCan;
    case "basic/Upload.svg" /* Upload */:
      return Upload;
    case "dual-light/add.svg" /* Add */:
      return Add;
    case "dual-light/add_circled.svg" /* AddCircle */:
      return AddCircle;
    case "dual-light/building.svg" /* Building */:
      return Building;
    case "dual-light/chevron_double_forward.svg" /* ChevronDoubleForward */:
      return ChevronDoubleForward;
    case "dual-light/dashboard.svg" /* Dashboard */:
      return Dashboard;
    case "dual-light/document.svg" /* Document */:
      return Document;
    case "dual-light/gift.svg" /* Gift */:
      return Gift;
    case "dual-light/growth.svg" /* Growth */:
      return Growth;
    case "dual-light/group.svg" /* Group */:
      return Group;
    case "dual-light/home.svg" /* Home */:
      return Home;
    case "dual-light/inbox.svg" /* Inbox */:
      return Inbox;
    case "dual-light/message.svg" /* Message */:
      return Message;
    case "dual-light/messages.svg" /* Messages */:
      return Messages;
    case "dual-light/note.svg" /* Note */:
      return Note;
    case "dual-light/open.svg" /* Open */:
      return Open;
    case "dual-light/send.svg" /* Send */:
      return Send;
    case "dual-light/settings.svg" /* Settings */:
      return Settings;
    case "dual-light/star.svg" /* Star */:
      return Star;
    case "dual-light/tool.svg" /* Tool */:
      return Tool;
    case "dual-light/trash.svg" /* Trash */:
      return Trash;
    case "dual-light/upload.svg" /* Upload */:
      return Upload2;
    case "dual-light/warning.svg" /* Warning */:
      return Warning;
    default:
      return null;
  }
