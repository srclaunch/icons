import { memo, ReactElement, SVGProps } from 'react'; export const Reload = memo((props: SVGProps<SVGSVGElement>): ReactElement<SVGElement> => {return (<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
  ...
  <defs>
    <linearGradient id="paint0_linear" x1="11.5001" y1="2" x2="11.5001" y2="22" gradientUnits="userSpaceOnUse">
