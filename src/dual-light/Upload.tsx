...
export const Upload = memo((props: SVGProps<SVGSVGElement>): ReactElement => {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <linearGradient id="paint0_linear" x1="12.0009" y1="4.49951" x2="12.0009" y2="16" gradientUnits="userSpaceOnUse">
          <stop stopColor="white" />
          <stop offset="1" stopColor="#D1DAEE" />
        </linearGradient>
        <linearGradient id="paint1_linear" x1="12" y1="14" x2="12" y2="20" gradientUnits="userSpaceOnUse">
