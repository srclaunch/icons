...
export const Messages = memo((props: SVGProps<SVGSVGElement>): ReactElement => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <linearGradient id="paint0_linear" x1="14" y1="16" x2="14" y2="0" gradientUnits="userSpaceOnUse">
          <stop stopColor="#6073D8" />
          <stop offset="1" stopColor="#5C5ACA" />
        </linearGradient>
        <linearGradient id="paint1_linear" x1="10" y1="8" x2="10" y2="24" gradientUnits="userSpaceOnUse">
