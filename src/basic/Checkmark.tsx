...
export const Checkmark = memo(
  (props: SVGProps<SVGSVGElement>): ReactElement => {
      return (
        <svg id="applab-icon-basic-checkmark" version="1.1" xmlns="http://www.w3.org/2000/svg"
          xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="442.533px" height="442.533px"
          viewBox="0 0 442.533 442.533" enableBackground="new 0 0 442.533 442.533" xmlSpace="preserve">
          <g>
