import { memo, ReactElement, SVGProps } from 'react'; export const Target = memo((props: SVGProps<SVGSVGElement>): ReactElement<SVGElement> => {return (<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
  ...
  <defs>
    ...
    <linearGradient id="paint2_linear" x1="12" y1="10" x2="12" y2="14" gradientUnits="userSpaceOnUse">
      <stop stopColor="white" />
      <stop offset="1" stopColor="#D1DAEE" />
    </linearGradient>
    <linearGradient id="paint3_linear" x1="16.9398" y1="1.62" x2="16.9398" y2="12.5" gradientUnits="userSpaceOnUse">
