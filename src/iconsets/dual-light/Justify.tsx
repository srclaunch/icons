import { memo, ReactElement, SVGProps } from 'react'; export const Justify = memo((props: SVGProps<SVGSVGElement>): ReactElement<SVGElement> => {return (<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
  ...
  <defs>
    <linearGradient id="paint0_linear" x1="12" y1="5" x2="12" y2="7" gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="paint2_linear" x1="12" y1="13" x2="12" y2="15" gradientUnits="userSpaceOnUse">
      <stop stopColor="white" />
      <stop offset="1" stopColor="#D1DAEE" />
    </linearGradient>
    <linearGradient id="paint3_linear" x1="12" y1="17" x2="12" y2="19" gradientUnits="userSpaceOnUse">
      <stop stopColor="#6073D8" />
      <stop offset="1" stopColor="#5C5ACA" />
    </linearGradient>
  </defs>
