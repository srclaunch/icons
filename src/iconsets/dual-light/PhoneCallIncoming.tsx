import { memo, ReactElement, SVGProps } from 'react'; export const PhoneCallIncoming = memo((props: SVGProps<SVGSVGElement>): ReactElement<SVGElement> => {return (<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
  ...
  <defs>
    <linearGradient id="paint0_linear" x1="2.53553" y1="4.46447" x2="19.5061" y2="21.435"
